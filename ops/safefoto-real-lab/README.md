...
The fork image uses the `stage13-safefoto-ui2` tag. Rebuild and update the tag for a newer commit. The source link and commit are embedded in the image metadata.
